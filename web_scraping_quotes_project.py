...
6. Better would be to store the data into a file or pickle file and load that file when starting the game
"""
...
"""
COLT'S WALKTHROUGH - SEE ...REFACTORED.PY FOR HIS REFACTORING APPROACH
